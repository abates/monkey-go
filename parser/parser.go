...
func precedence(typ token.TokenType) int {
...
func (p *Parser) parseIntegerLiteral() ast.Expression {
	...
	if err != nil {
		// how can this ever occur? Doesn't the lexer guarantee that the
		// integer token only contain symbols that represent an integer?
